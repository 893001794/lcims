 ...
 *
 */
public class StatisticsTask1 extends TimerTask {
...
//		String head = "[周("+WStart+"至"+WEnd+")/月("+MStart+"至"+MEnd+")的统计报表]";
		...
		content.append("</td>");
		content.append("<td>");
		content.append("月收订单额");
		content.append("</td>");
		content.append("<td>");
		content.append("月收历史款");
		content.append("</td>");
		content.append("<td>");
		content.append("月收当月款");
		content.append("</td>");
		content.append("<td>");

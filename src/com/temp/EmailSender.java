...
public class EmailSender {
    ...
    public static void main(String[] args) throws Exception {
    	EmailSender.send(new String[]{"tangzp@lccert.com"}, "XXXXXXXXXX", "<b>测试邮件发送</b>",null , "text/html");
    }
    /**
     * 发送邮件
     * @param receiver 收件人
    ...
    public static void send(String[] receivers, String subject, String mailContent, File[] attachements, String mimetype) {
        ...
        props.put("mail.smtp.host", "123.100.1.135");//Smtp服务器地址
        props.put("mail.smtp.auth", "true");//需要校验
        Session session = Session.getDefaultInstance(props, new Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("sw@china34.com.cn","XXXXXXXXX");//登录用户名/密码
            }
        });
//        session.setDebug(true);
        try {
            MimeMessage mimeMessage = new MimeMessage(session);
            mimeMessage.setFrom(new InternetAddress("sw@china34.com.cn","XXXXXXXXXXXXXXXXXX"));//发件人邮件

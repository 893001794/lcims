...
<%
	...
	if (command != null && "search".equals(command)) {
		...
		list= ProjectChemImpl.getInstance().searchProjectManarge(year,month,sale,pid,rid,parttype,"food");
	} else {
		list = ProjectChemImpl.getInstance().searchProjectManarge(year,month,"","","",parttype,"food");
	}
	...
	<head>
		...
		function showdialog(sid) {
		   ...
		   var myform =document.getElementById("search");
			myform.action ="food_manager.jsp";
			myform.submit();
			}
            	...
            	<div id="mydiv">
            		...
            		<script>   
						     ...
						     //alert("-----");
						         ...
						         search.action ="food_manager.jsp?command=search&parttypecb="+cb.value;
						         search.submit();
						     }   
						 </script>

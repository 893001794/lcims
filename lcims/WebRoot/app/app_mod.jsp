...
if(command != null && "mod".equals(command)) {
	...
	if(ApplicationAction.getInstance().modifyApplication(af)) {
		out.println("修改成功");
...
ApplicationForm af = ApplicationAction.getInstance().getApp(id);
...
window.history.back();
	...
	<body lang=ZH-CN
		...
		<form id="form1" name="form1" method="post"
			action="app_mod.jsp?command=mod" autocomplete="off">
		<input name="id" value="<%=af.getId() %>" type="hidden" />
			<div align="center">
				<font size="6">
					修改请款申请表
				</font>
						...
						<td colspan=4
							...
							<p align=center class=MsoNormal style='text-align: center'>
								<span id="invtype"
									...
									<input name="invtype" value="发票" type="checkbox"
 ...
 <script type="text/javascript">
								var obj2 = document.getElementById("invtype");
								for(var i=0;i<obj2.children.length;i++) {
									if(obj2.children[i].value.charCodeAt() == "<%=af.getInv_type()%>".charCodeAt()){
						...
						<td colspan=4
							...
							<input name="invhead" align="center" type="text" value="<%=af.getInv_head() %>"
					...
					<tr style='mso-yfti-irow: 2; height: 15.55pt'>
						...
						<td colspan=3
							...
							<input id="suppliername" type="text" value="<%=af.getSup().getName() %>" name="suppliername"
					...
					<tr style='mso-yfti-irow: 4; height: 15.55pt'>
						<td width="131"
							style='width: 11.68%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt;'>
							<input name="prepaytime1" align="center" type="text" value="<%=new SimpleDateFormat("yyyy-MM-dd").format(af.getPrepay_time1()) %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td width="211"
							...
							<input name="constractcode1" align="center" type="text" value="<%=af.getContract_code1() %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td colspan=2
							style='width: 24.74%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
							<input name="constractcontent1" align="center" type="text"
								value="<%=af.getContract_content1() %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td width="144"
							style='width: 10.9%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
							<input name="constractprice1" align="center" type="text" value="<%=af.getContract_price1() %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td width="131"
							style='width: 10.82%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
							<input name="firstpay" align="center" type="text" value="<%=af.getFirst_pay() %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td width="131"
							style='width: 10.9%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
					...
					<tr style='mso-yfti-irow: 5; height: 15.55pt'>
						<td width="131"
							style='width: 11.68%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
							<input name="prepaytime2" align="center" type="text" value="<%=af.getPrepay_time2()==null?"":new SimpleDateFormat("yyyy-MM-dd").format(af.getPrepay_time2()) %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td width="211"
							style='width: 18.0%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
							<input name="constractcode2" align="center" type="text" value="<%=af.getContract_code2() %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td colspan=2
							style='width: 24.74%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
							<input name="constractcontent2" align="center" type="text"
								value="<%=af.getContract_content2() %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td width="144"
							style='width: 10.9%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
							<input name="constractprice2" align="center" type="text" value="<%=af.getContract_price2()==0?"":af.getContract_price2() %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td width="131"
							style='width: 10.82%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt; height: 15.55pt'>
							<input name="secondpay" align="center" type="text" value="<%=af.getSecond_pay()==0?"":af.getSecond_pay() %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td width="131"
							style='width: 10.9%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
					...
					<tr style='mso-yfti-irow: 6; height: 15.55pt'>
						<td width="131"
							style='width: 11.68%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
							<input name="prepaytime3" align="center" type="text" value="<%=af.getPrepay_time3()==null?"":new SimpleDateFormat("yyyy-MM-dd").format(af.getPrepay_time3()) %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td width="211"
							style='width: 18.0%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
							<input name="constractcode3" align="center" type="text" value="<%=af.getContract_code3() %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td colspan=2
							style='width: 24.74%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
							<input name="constractcontent3" align="center" type="text"
								value="<%=af.getContract_content3() %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td width="144"
							style='width: 10.9%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt; height: 15.55pt'>
							<input name="constractprice3" align="center" type="text" value="<%=af.getContract_price3()==0?"":af.getContract_price3() %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td width="131"
							style='width: 10.82%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt; height: 15.55pt'>
							<input name="thirdpay" align="center" type="text" value="<%=af.getThird_pay()==0?"":af.getThird_pay() %>"
								style="width: 100%; height: 100%; border: 0; background: yellow; text-align: center;" />
						</td>
						<td width="131"
							style='width: 10.9%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt;  height: 15.55pt'>
					...
					<tr style='mso-yfti-irow: 7; height: 15.55pt'>
						...
						<td colspan=3
							...
							<p id="paymethods" align=center class=MsoNormal
								...
								<input name="paymethod" value="款到发货" type="checkbox"
 ...
 <script type="text/javascript">
						...
						<td colspan=3
							...
							<p id="paytypes" align=center class=MsoNormal
								style='text-align: center'>
								<input name="paytype" value="现金" type="checkbox"
 ...
 <script type="text/javascript">
					...
					<tr style='mso-yfti-irow: 10; height: 19.85pt'>
						...
						<td colspan=3
							style='width: 42.74%; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt; border-right: solid windowtext 1.0pt; mso-border-top-alt: solid windowtext .25pt; mso-border-left-alt: solid windowtext .25pt; mso-border-alt: solid windowtext .25pt; height: 19.85pt'><br>
							<div id="item"></div>
		<script type="text/javascript">
...
*/
			...
			$("#item").mlnColsel(ob,{
				title:"<%=dydata.getItemById(af.getItem())%>",
				value:"<%=af.getItem()%>",
				width:400
			});
						...
						<td colspan=3
							...
							<select name="dept"
								...
								for(String value:map.keySet()) {
								 %>
								<option value="<%=map.get(value) %>" <%=map.get(value).equals(af.getDept())?"selected":"" %>><%=map.get(value) %></option>
								<%
								 }
								%>
							</select>

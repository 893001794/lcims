...
<%
	...
	List<Item> items = ItemAction.getInstance().getItemByKeyWords(key);
	System.out.println(items.size()+"：化学");
...
//System.out.println("json:" + json);
	...
	//response.getWriter().println("[{\"itemid\":\"01.01\",\"name\":\"Lead(Pb)\",\"saleprice\":\"80.0\",\"standprice\":\"100.0\",\"outprice\":\"0.0\"},{\"itemid\":\"01.02\",\"name\":\"Cadmium(Cd)镉\",\"saleprice\":\"100.0\",\"standprice\":\"100.0\",\"outprice\":\"0.0\"}]");
%>

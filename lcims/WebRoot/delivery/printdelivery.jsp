...
function printorder()
{
      ...
      //  factory.ExecWB(8,1) ;              //打印页面设置 
       // factory.printing.printer = "OKi5530" //设置默认打印机
        ...
        window.showModalDialog("../chemistry/projectismethod.jsp?sid=<%=sid%>&status=<%=status%>&search=search","","dialogWidth:900px;dialogHeight:700px");
		//window.close();  //关闭页面
		window.opener=null;
       window.open('','_self');
       window.close();  //关闭页面
	...
	<body onload="printorder();">
		<table width="680" border="0" align="left" cellpadding="0"
			...
			<tr><!-- height =25 -->
				...
				<td height="20"  width="70"  style='text-align: left;vertical-align: middle' >√</td>
			...
			<tr><!-- height =25 -->
				...
				<td height="15"  width="70"  style='text-align: left;vertical-align: middle' >&nbsp;</td>
			...
			<tr>
				...
				<td height="26"  width="70"><%=freightcollect %></td>
			...
			<!-- height=63 -->
			<tr>
				<td height="65"  colspan="4" style='text-align: left;vertical-align: middle'>
				<%=contactAdd %>
				</td>
				<td height="65" class="ziti3" width="65">&nbsp;</td>
				<td height="65" class="ziti3" width="65">&nbsp;</td>
				<td height="65" class="ziti3" width="65">&nbsp;</td>
			</tr>
			...
			<tr>
				<td height="2" align="left" colspan="2" style='text-align:left;vertical-align: middle'>
						<%=recipient %>
				</td>
				<td height="2" align="center"  colspan="2" style='text-align: left;vertical-align: middle'>
						&nbsp;&nbsp;<%=contactTEL %>
				</td>
				<td height="2" class="ziti3" width="65">&nbsp;</td>
				<td height="2" class="ziti3" width="65">&nbsp;</td>
				<td height="2" class="ziti3" width="65">&nbsp;</td>
				<td height="2" class="ziti3" width="160" rowspan="2">&nbsp;</td>
			</tr>
			<!-- height=43 -->
			<tr>
				<td height="75"  colspan="2" style='text-align: left; ' >
					<%=consignA %>
				</td>
				<td height="75" class="ziti3" width="65" colspan="2">&nbsp;</td>
				<td height="75" class="ziti3" width="65" colspan="3">&nbsp;</td>
			</tr>
			<!-- height=43 -->						
			<tr>
				<td height="45" class="weizi1" colspan="2">
					
				</td>
				<td height="45" class="weizi1" width="98">
					
				</td>
				<%
				SimpleDateFormat sdf=new SimpleDateFormat("dd/MM");
				 %>
				<td height="45" align="right"   width="35"><%=sdf.format(new Date()) %></td>
				<td height="45" class="ziti3"   width="65" align="right">&nbsp;</td>

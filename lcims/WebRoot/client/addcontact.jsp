		...
		<form method="post" name="projectform" id="projectform"
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="1">
				...
				<tr>
					...
					<td width="90%">
						<input name="purchase" type="text" id="purchase" size="60" />
					</td>
				</tr>
				<tr>
					<td width="10%">
					...
					<td width="90%">
						<input name="level" type="text" id="level" size="60" />
					</td>
				</tr>
				<tr>
					<td width="10%">
					...
					<td width="90%">
						<input name="degree" type="text" id="degree" size="60" />
					</td>
				</tr>
				<tr>
					<td width="10%">
					...
					<td width="90%">
						<input name="visitnum" type="text" id="visitnum" size="60" />
					</td>
				</tr>
				...
				<tr>
					...
					<td width="90%">
						<input name="notes" type="text" id="notes" size="60" />
					</td>
				</tr>
			...
			<div align="center">
				<input name="btnAdd" class="button1" type="button" id="btnAdd"
					value="添加联系人" onclick="addproject()">
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="btnBack" class="button1" type="button" id="btnBack"
					value="关闭" onclick="goBack()" />
			</div>
		</form>
	</body>
</html>

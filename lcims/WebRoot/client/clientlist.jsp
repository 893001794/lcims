...
<%
	...
	PageModel pm = ClientAction.getInstance().getClients(pageNo,pageSize);
%>
...
<html>
	...
	function topPage() {
		window.self.location = "clientlist.jsp?pageNo=1";
	}
	
	function previousPage() {
		window.self.location = "clientlist.jsp?pageNo=<%=pm.getPreviousPageNo() %>";
	}	
	
	function nextPage() {
		window.self.location = "clientlist.jsp?pageNo=<%=pm.getNextPageNo() %>";
	}
	
	function bottomPage() {
		window.self.location = "clientlist.jsp?pageNo=<%=pm.getBottomPageNo() %>";
	}
		...
		<form name="userform" id="userform">
			...
			<table width="95%" border="1" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td class="rd8">
						[<a href="contactmgr.jsp?clientid=<%=client.getClientid() %>">查看</a>]
					</td>

				...
				<tr>
					<td >
						<div id="mydiv">
							...
							全部
							<input type="checkbox" name="parttype" value="all" onClick="chooseOne(this);" />
							|&nbsp; 未审核
							<input type="checkbox" name="parttype" value="no" onClick="chooseOne(this);"/>
							|&nbsp;已审核
							<input type="checkbox" name="parttype" value="yes" onClick="chooseOne(this);"/>

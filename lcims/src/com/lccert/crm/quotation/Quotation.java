...
public class Quotation {
	...
	private String collRemarks; //收款备注
	private int clientid;  //获取用户信息
	private String object ;
	private Object obj;
	private float sumOtherscost ;
	private float adjustinvcount;    //更改报价单的总金额
	private String oldPid;   //关联旧的报价单
	private String rpclient; //报告客户名称
	private String greenchannel;  //绿色通道
	private float projectPrice ;  //单个项目的金额;
	private int confirmid ;  //记录打折后审批经理的id
	private float advarceFactor ; //预收款系数
	private float sepayFactor ;  //二次收款系数
	private float balanceFactor; //尾次收款系数
	private String amstart ; // 上午租场开始时间
	private String amend  ;  //上午租场结束时间
	private String pmstart ; //下午 租场开始时间
	private String pmend  ;  //下午租场结束时间
	private String product;  //产品名称
	private Date collection ;   //收件时间
	private Date test  ;      //测试时间
	private Date receipt ;    //收单时间
	private Date finish  ;    //报价单完成时间
	private float deductions ; //追款抵扣系数
	private float channel ; //通道系数
	
	private String sampling;  //记录东莞edm环境部采样员名称
	private Date sampltime;  //记录东莞edm环境部采样时间 
	private String createname ;  //排单人员
	private String lock ; //锁
	private float fluSum ; //冲红金额
	private String clientContact ; //获取客户区域
	private String badDebt; //坏账扣款
